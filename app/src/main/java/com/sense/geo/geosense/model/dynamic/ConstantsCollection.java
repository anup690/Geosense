...
public class ConstantsCollection {
	...
	public static final String DATABASE_NAME = "DynamicSqlite";
	...
	public static final String SQLITE_INTEGER_PRIMARY_KEY							= 	" INTEGER PRIMARY KEY ";//replaced comma with a space
